...
const transitions: Record<string, string[]> = {
  ORDER_RECEIVED: ["ORIGIN_CONFIRMED", "EXCEPTION", "CANCELLED"],
  ORIGIN_CONFIRMED: ["PICKUP_SCHEDULED", "EXCEPTION", "CANCELLED"],
  PICKUP_SCHEDULED: ["RECEIVED_AT_ORIGIN", "EXCEPTION"],
  RECEIVED_AT_ORIGIN: ["QC_IN_PROGRESS", "EXCEPTION"],
  QC_IN_PROGRESS: ["REPACK_IN_PROGRESS", "READY_FOR_CONSOLIDATION", "EXCEPTION"],
  REPACK_IN_PROGRESS: ["READY_FOR_CONSOLIDATION", "EXCEPTION"],
  READY_FOR_CONSOLIDATION: ["CONSOLIDATED", "EXCEPTION"],
  CONSOLIDATED: ["BOOKED", "EXCEPTION"], BOOKED: ["ORIGIN_DEPARTED", "EXCEPTION"],
  ORIGIN_DEPARTED: ["IN_TRANSIT", "EXCEPTION"], IN_TRANSIT: ["DESTINATION_ARRIVED", "EXCEPTION"],
  DESTINATION_ARRIVED: ["CUSTOMS_CLEARANCE", "EXCEPTION"], CUSTOMS_CLEARANCE: ["CUSTOMS_RELEASED", "EXCEPTION"],
  CUSTOMS_RELEASED: ["LAST_MILE_TENDERED", "EXCEPTION"], LAST_MILE_TENDERED: ["OUT_FOR_DELIVERY", "EXCEPTION"],
  OUT_FOR_DELIVERY: ["DELIVERED", "EXCEPTION"], EXCEPTION: ["ORIGIN_CONFIRMED", "PICKUP_SCHEDULED", "RECEIVED_AT_ORIGIN", "QC_IN_PROGRESS", "READY_FOR_CONSOLIDATION", "IN_TRANSIT", "CUSTOMS_CLEARANCE", "LAST_MILE_TENDERED", "OUT_FOR_DELIVERY", "CANCELLED"],
};
